        ...
        <div className="w-full pt-6 sm:pt-0 flex items-center justify-center max-w-screen-sm mx-auto">
          <div className={`${css.wrapper} scrollbar-hide`}>
            <div className={css.top}>
              <div className="w-14 h-14 text-[#01abab] text-3xl mb-7 sm:mb-6 rounded-xl border shadow-sm flex items-center justify-center">
              ...
              <div className="mt-10 py-3 px-5 border shadow-sm rounded-lg text-sm">
