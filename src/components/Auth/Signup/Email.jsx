...
const Email = () => {
  ...
  return (
    <>
      <div className="w-full md:min-h-screen flex justify-center items-center flex-col max-w-screen-sm mx-auto">
        <div className="w-full py-8 pb-5 sm:py-7 px-8 sm:px-16 flex items-center gap-3 mb-0 md:mb-7">
          ...
          <div className={css.wrapper}>
            ...
            >
              {({ errors, setFieldValue, touched }) => (
                <Form className={`${css.emailForm} mt-5 md:mt-10`}>
                  ...
                  <p className="text-sm text-center font-medium text-default-600 mt-10">
                    ...
                    <NavLink className="text-blue-400 italic" to={"/"}>
                      {t("login")}
                    </NavLink>
                  </p>
                </Form>
