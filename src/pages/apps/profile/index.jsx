...
const ProfilePage = () => {
  ...
  const { user: authUser, isLoading: isLoadingUser } = useUserData();
  ...
  return (
    <div className={css.wrapper}>
      <div className="my-6 md:my-6 px-2 sm:px-4">
        <div className="h-[64px] flex items-center border-b-1 border-b-hintSecondary">
